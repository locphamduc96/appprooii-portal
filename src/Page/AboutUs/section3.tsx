    ...
    <div className='section3'>
      ...
      <div className='section3-content section3-product-market'>
        ...
        <div className='section3-content-desc'>
          There's no need to choose black or white while grey <br />
          option always exists. Our strategic approach is finding <br />
          the common area of consumer needs/wants/demands <br />
      ...
      <div className='section3-content section3-evidence-base'>
        ...
        <div className='section3-content-desc'>
          We monitors every next action not by somebody's <br />
          opinions but by data, especially the data closer to the <br />
          business results, such as acquisition cost on customer <br />
          lifetime value as well as the data from qualitative <br />
      ...
      <div className='section3-content section3-agile'>
        ...
        <div className='section3-content-desc'>
          Given that market conditions are evolving so quickly <br />
          that marketing needs a more reactive planning cycle, <br />
          our growth marketing service needs to follow suit in <br />
          that hypotheses are formed quarterly, new tactics and <br />
          experiments are prioritized and executed on a monthly <br />
